...
public interface LeaderRetrievalEventHandler {
     ...
     *
     * @param leaderInfo the new leader information to notify {@link LeaderRetrievalService}. It
     *     could be {@link LeaderInformation#empty()} if the leader address does not exist in the
     *     external storage.
     */
