 ...
 * ShuffleWorker communication to.
 *
 ...
 *
 * <p>This class is copied from Apache Flink (org.apache.flink.runtime.net.ConnectionUtils).
 */
public class ConnectionUtils {
    ...
    /**
     * This utility method tries to connect to the ShuffleManager using the InetAddress returned by
    ...
    public static class LeaderConnectingAddressListener implements LeaderRetrievalListener {
        ...
        public InetAddress findConnectingAddress(Duration timeout) throws Exception {
        ...
        public InetAddress findConnectingAddress(Duration timeout, Duration startLoggingAfter)
            ...
            try {
                while (elapsedTimeMillis < timeout.toMillis()) {
                    ...
                    synchronized (retrievalLock) {
                        ...
                        if (retrievalState == LeaderRetrievalState.NOT_RETRIEVED) {
                            ...
                            targetAddress =
                                    AkkaRpcServiceUtils.getInetSocketAddressFromAkkaURL(akkaURL);
                    ...
                    if (targetAddress != null) {
                        ...
                        do {
                            InetAddress address =
                                    findAddressUsingStrategy(strategy, targetAddress, logging);
                            if (address != null) {
                                return address;
                            }
                ...
                if (heuristic != null) {
                    ...
                    LOG.warn(
                            "Could not find any IPv4 address that is not loopback or link-local. "
                ...
                throw new Exception(
                        String.format(
                                "Could not retrieve the connecting address to the current leader "
                                        + "with the akka URL %s .",
                                akkaURL),
                        e);
            }
        ...
        public void notifyLeaderAddress(LeaderInformation leaderInfo) {
            ...
            if (leaderAddress != null && !leaderAddress.isEmpty()) {
                synchronized (retrievalLock) {
                    ...
                    retrievalState =
                            LeaderConnectingAddressListener.LeaderRetrievalState.NEWLY_RETRIEVED;
