...
public interface ShuffleWorkerGateway extends RemoteShuffleRpcGateway {
    ...
    /**
     * Get shuffle worker metrics.
     *
     * @return the shuffle worker metrics currently.
     */
    CompletableFuture<ShuffleWorkerMetrics> getWorkerMetrics();
}
