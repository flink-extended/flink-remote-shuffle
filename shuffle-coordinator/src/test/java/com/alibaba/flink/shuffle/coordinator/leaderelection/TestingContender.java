...
public class TestingContender extends TestingLeaderBase implements LeaderContender {
    ...
    public void grantLeadership(UUID leaderSessionID) {
        ...
        leaderElectionService.confirmLeadership(new LeaderInformation(leaderSessionID, address));

        leaderEventQueue.offer(new LeaderInformation(leaderSessionID, address));
    }
