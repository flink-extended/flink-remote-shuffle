...
public class TestRegistrationGateway extends TestingGatewayBase {
    ...
    public TestRegistrationGateway(RegistrationResponse... responses) {
        CommonUtils.checkArgument(responses != null && responses.length > 0);
    ...
    public CompletableFuture<RegistrationResponse> registrationCall(UUID leaderId) {
        invocations.add(new RegistrationCall(leaderId, 10));
