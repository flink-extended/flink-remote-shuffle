...
/** {@link RpcEndpoint} for remote shuffle. */
public abstract class RemoteShuffleRpcEndpoint extends RpcEndpoint {

    protected RemoteShuffleRpcEndpoint(RemoteShuffleRpcService rpcService, String endpointId) {
